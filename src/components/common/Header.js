    ...
    useEffect(() => {
        if (isHomePage) {
            ...
            if (logoElement) {
                ...
                return () => {
                    if (logoElement) {
                        logoElement.classList.remove('animate__animated', 'animate__backInRight', 'animate__jello');
                        logoElement.removeEventListener('animationend', handleAnimationEnd);
                    }
                };
            }
            ...
            <div className={styles.nav}>
                <ul className={styles.navList}>
                    <li className={styles.navItem}>
                        <button className={styles.navButton} onClick={() => handleNavigation("/")}>홈</button>
                    </li>
                    <li className={styles.navItem}>
                        <button className={styles.navButton} onClick={() => handleNavigation("/social")}>소셜</button>
                    </li>
                    <li className={styles.navItem}>
                        <button className={styles.navButton} onClick={() => handleNavigation("/post")}>게시판</button>
                    </li>
                </ul>
            </div>
